    ...
    return (
        ...
        <div>
            <form onSubmit={onSubmit}>
                <i className="fa-brands fa-youtube fa-fw fa-2x"></i><i className="fa-brands fa-spotify fa-fw fa-2x"></i><input placeholder="Spotify or Youtube URL" ref={urlInput} type="text" className="searchInput"></input> <button type="submit"><i className="fa-solid fa-cloud-arrow-up"></i></button> <button type="submit"> <i className="fa-solid fa-times" onClick={props.onClose}></i></button>
            </form>
        </div>
        <ReactResumableJs
            filetypes={["mp3"]}
