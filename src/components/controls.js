function Controls(props) {
    return (
        ...
        &nbsp;<button onClick={props.toggleAAC} style={{fontSize: "0.5"}}><span style={{fontSize: !props.useAAC ? "1.5em" : "1em"}}>MP3</span><span>|</span><span style={{fontSize: props.useAAC ? "1.5em" : "1em"}}>AAC</span></button>
        </div>
    );
}
