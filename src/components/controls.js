function Controls(props) {
    return (
        ...
        { props.audioPlayer?.paused && <button onClick={props.onPlay}><i className="fa-solid fa-play fa-fw"></i></button>}
        { !props.audioPlayer?.paused && <button onClick={() => props.audioPlayer?.pause()}><i className="fa-solid fa-pause fa-fw"></i></button>}
